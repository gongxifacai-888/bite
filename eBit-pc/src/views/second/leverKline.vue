    ...
    <div class="bgheader bdbheader flex alcenter nmb_ptb10">
      ...
      <div class>
        ...
        <div class="flex1 tc hidden-xs">
            ...
            <span class="flex1 baselight2">${{ currency_matchInfo.currency_quotation.close || "0.00"}}</span>
            <p class="flex1 flex alcenter jscenter">
                <img src="../../assets/images/red.png" class="wt25" v-show="currency_matchInfo.currency_quotation.change<0" alt="">
                <img src="../../assets/images/green.png" class="wt25" v-show="currency_matchInfo.currency_quotation.change>=0"  alt="">
                <span
                class=""
                :class="[currency_matchInfo.currency_quotation.change < 0 ? 'red' : 'green']"
            >{{currency_matchInfo.currency_quotation.change < 0 ? '' : '+'}}{{ currency_matchInfo.currency_quotation.change || "0.00" | filterDecimals }}%</span>
            </p>
