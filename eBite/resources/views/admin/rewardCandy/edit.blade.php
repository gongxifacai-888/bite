                ...
                <ul class="layui-timeline">
                    ...
                    <li class="layui-timeline-item">
                        ...
                        <div class="layui-timeline-content layui-text">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label">发放币种</label>
                                <div class="layui-input-block">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="inc_number" class="layui-input" value="0"
                                    >
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="total_number" class="layui-input" value="0"
                                    >
                                </div>
                            </div>
                        </div>
...
<script>
    layui.config({
        ...
        form.on('submit', function (data) {
            $.post('/admin/reward_candy/update', data.field, function (res) {
                layer.msg(res.msg);
                if (res.code) {
                    setTimeout(function () {
                        location.reload()
